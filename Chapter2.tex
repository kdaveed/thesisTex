...
To illustrate the utility of restrictions, the ontology from the previous section was extended with three subclasses (\figref{ontExt1}). The abbreviations \textit{CS} stands for computer science.
