...
\img{\V}{JS_form_formElement.png}{Form and FormElement JS classes}{JS_form_element}
...
\begin{lstlisting}[basicstyle=\footnotesize, frame=single, caption={FormElement JS class}, label=formElement, captionpos=b, belowskip=1em, aboveskip=2em]
...
\begin{lstlisting}[basicstyle=\footnotesize, frame=single, caption={Subform adder routine}, label=JS_subFormRoutine, captionpos=b, belowskip=1em, aboveskip=2em]
class SubformAdder {
	constructor(descriptor, formData){
...
\img{\V}{UML_vd.png}{UML class diagram of the VariableDependency class}{UML_vd}
...
\begin{lstlisting}[basicstyle=\footnotesize, frame=single, caption={SPARQL query generated based on class restriction triple}, label=JS_subFormRoutine, captionpos=b, belowskip=1em, aboveskip=2em]
...
\img{\V}{UML_graph.png}{UML class diagram of the class Graph}{UML_graph}
