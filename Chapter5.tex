...
\figref{formDescriptor} illustrates the generated JSON object for a form with the data dependencies too. The task of the JavaScript routine is to interpret this configuration data and load the main form and subforms.
