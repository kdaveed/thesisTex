...
The two discussed use-case shows that the form scheme is defined by the designed vocubulary, which is the representation of the extension scheme. So the designed system offers a language to build web application rapidly on the top of different ontology extension schemes.
