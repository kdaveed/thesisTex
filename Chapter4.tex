...
\imgK{\IVI}{basicFlow.png}{Basic workflow}
...
\itemI{Can be modelled by a configuration dataset}
...
\imgK{\IVI}{frameworkFunc.png}{Framework functionality}
...
\imgK{\IVI}{ontologyForm.png}{Web application ontology for the form}
...
\imgK{\IVI}{difference.png}{Difference between sub form adders}

\itemI{min, max cardinality will be here addressed}

\imgK{\IVI}{formDescRDF.png}{Form descriptor RDF Data}
...
\end{itemize}
\imgK{\IVI}{statement.png}{Statement in RDF Vocabulary}
...
\end{itemize}
\imgK{\IVI}{coreOntology.png}{Core ontology}
...
\imgK{\IVI}{variableTypes.png}{Variable types}
...
\imgK{\IVI}{ontologyStatement.png}{Statement types and attributes}
...
\imgK{\IVI}{tripleSet1.png}{Statement configuration dataset I}
...
\imgK{\IVI}{tripleSet2.png}{Statement configuration dataset II.}
...
\imgK{\IVI}{formDefinition1.png}{Form definition dataset}
...
\imgK{\IVI}{base.png}{Base definition of the data input process}
...
\imgK{\IVII}{selectorVsFormGraph.png}{Selector VS form graph}
...
\imgK{\IVII}{navigatorClassDiagram.png}{Navigator class diagram}
