...
This use-case shows that the form scheme is defined by the designed vocubulary, namely that there is an assay adder and each assay sub form has a bone selector and an output measurement datum selector. But what kind of assays, bone segments and measurements are there is defined in the extensions. So the designed system offers a language to build web application rapidly on the top of different ontology extension schemes.
