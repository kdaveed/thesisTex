...
The ontology extensions describing such investigations, contains all assays as different OWL classes, that are connected to some bone segment classes with restrictions, and to some output measurement datums. \figref{sdeExt} shows the subset of the OBI ontology extension for the assay \textit{Glabella}. 
...
The complete RDF graph pattern can be seen on the following image, where the green nodes are the constants. 
